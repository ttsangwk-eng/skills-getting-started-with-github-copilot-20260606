...
activities = {
    ...
    "Drama Club": {
        "description": "Rehearse plays and learn acting techniques",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["ethan@mergington.edu", "hazel@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Solve challenging math problems and prep for competitions",
